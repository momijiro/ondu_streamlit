...
## 入力のイメージ
- OND'Uでは、以下のようなファイルが出力されます。これを入力として用います。
- デモとして、「学生支部-20211008-20211107.csv」というファイルをdataに格納しています。(実際には社会人支部のファイルも必要です)
...
## 出力のイメージ
- 作成したアプリを用いると、以下のようなファイルが出力されます。  
- デモとして、「体温記録_20211025_20211107.xlsx」というファイルをcodeに格納しています。
